    ...
    >
      <div className="card-base card-premium max-w-4xl p-7">
        <div className="space-y-6 text-base leading-8 text-slate-300">
          <p>
            This website currently collects only the information a visitor chooses to provide through
            the contact form or email link. The contact form opens an email draft and is not connected
            to a production mail backend at this stage.
          </p>
          <p>
          ...
          <p>
            ...
            reflect the final analytics, hosting, form-processing, retention and data-subject request
            processes used by Corentis Technologies.
          </p>
        </div>
      </div>
    </Section>
