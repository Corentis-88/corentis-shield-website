...
const readyConversations = [
  ...
  {
    title: "Investor/funder discussion",
...
export default function PartnersAndFundersPage() {
  return (
    <>
      <Section
      ...
      <Section title="Partner and funder packs">
      ...
      <Section>
        <CTABanner
          ...
          secondaryLabel="View pilot report"
          secondaryHref="/pilot-report"
        />
      </Section>
    </>
  );
