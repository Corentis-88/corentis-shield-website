  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      >
        ...
        <defs>
          <linearGradient id="corentisMarkBg" x1="7" y1="5" x2="42" y2="44" gradientUnits="userSpaceOnUse">
      ...
      {showWordmark && (
        <span className="text-sm font-semibold tracking-wide text-white">Corentis Technologies</span>
      )}
    </div>
  );
}
